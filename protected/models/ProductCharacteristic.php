 ...
 */
class ProductCharacteristic extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'characteristic' => array(self::BELONGS_TO, 'Characteristics', 'characteristic_id'),
	 ...
	 * @return ProductCharacteristic the static model class
	 */
